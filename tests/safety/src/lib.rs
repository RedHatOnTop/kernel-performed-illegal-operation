...
impl SafetyCheck for HeapAllocTest {
    fn name(&self) -> &str { "heap_allocation" }
...
impl SafetyCheck for BoxAllocTest {
    fn name(&self) -> &str { "box_allocation" }
