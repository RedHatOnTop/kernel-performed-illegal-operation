...
impl Instant {
    ...
    pub fn now() -> Instant {
        let nanos = syscall::time_monotonic()
            .unwrap_or(0);
        Instant { nanos }
    }
    ...
    pub fn checked_add(&self, duration: Duration) -> Option<Instant> {
        self.nanos.checked_add(duration.as_nanos() as u64)
            .map(|n| Instant { nanos: n })
    }
    
    /// Returns `Some(t)` if `t` is before this instant.
    pub fn checked_sub(&self, duration: Duration) -> Option<Instant> {
        self.nanos.checked_sub(duration.as_nanos() as u64)
            .map(|n| Instant { nanos: n })
    }
...
impl SystemTime {
    ...
    pub fn now() -> SystemTime {
        let (secs, nanos) = syscall::time_realtime()
            .unwrap_or((0, 0));
    ...
    pub fn duration_since(&self, earlier: SystemTime) -> Result<Duration, SystemTimeError> {
        if *self < earlier {
            return Err(SystemTimeError(earlier.duration_since_epoch() - self.duration_since_epoch()));
        }
    ...
    pub fn checked_add(&self, duration: Duration) -> Option<SystemTime> {
        ...
        self.secs.checked_add(duration.as_secs())
    ...
    pub fn checked_sub(&self, duration: Duration) -> Option<SystemTime> {
        ...
        total_nanos.checked_sub(duration)
            .map(|d| SystemTime {
                secs: d.as_secs(),
...
impl Duration {
    ...
    pub fn checked_add(self, rhs: Duration) -> Option<Duration> {
        ...
        self.secs.checked_add(rhs.secs)
            .and_then(|s| s.checked_add(extra_secs))
    ...
    pub fn checked_mul(self, rhs: u32) -> Option<Duration> {
        ...
        self.secs.checked_mul(rhs as u64)
            .and_then(|s| s.checked_add(extra_secs))
            .map(|secs| Duration { secs, nanos })
    }
