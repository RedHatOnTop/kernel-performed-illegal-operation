...
#[cfg(test)]
mod tests {
    use crate::process::{ProcessId, ProcessState, ProcessError};
    ...
    fn test_signal_numbers() {
        ...
        let signals = [SIGHUP, SIGINT, SIGQUIT, SIGKILL, SIGTERM, SIGCHLD, SIGSTOP, SIGCONT];
    ...
    fn test_resource_limits() {
        ...
        let file_limit = Rlimit { soft: 1024, hard: 4096 };
