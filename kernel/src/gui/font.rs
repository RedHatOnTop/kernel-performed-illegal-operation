//! 8x8 Bitmap Font
//!
//! Simple ASCII bitmap font for text rendering.

/// 8x8 bitmap font
pub struct Font8x8;

impl Font8x8 {
    /// Get glyph for character (8 bytes, each byte is a row)
...
/// Font data for ASCII characters 0-127
static FONT_DATA: [[u8; 8]; 128] = [
    // 0x00 - NULL
