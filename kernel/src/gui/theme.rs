...
//! Inspired by modern flat design with glassmorphism accents.
//! All UI components reference these values for visual consistency.
//!
//! ## Design Philosophy
//! - Soft, rounded shapes with consistent corner radii
//! - Subtle depth through shadows and translucency (no hard pixel edges)
//! - High contrast text for readability
//! - Muted, professional color palette with vibrant accents
...
impl Accent {
    ...
    pub const DANGER: Color      = Color::rgb(235, 77, 75);    // Soft red
    pub const DANGER_HOVER: Color = Color::rgb(255, 100, 98);
...
impl Surface {
    // Desktop & root
    pub const DESKTOP_TOP: Color    = Color::rgb(15, 15, 30);
    pub const DESKTOP_BOTTOM: Color = Color::rgb(30, 40, 65);

    // Taskbar
    pub const TASKBAR: Color        = Color::rgba(22, 22, 28, 230);
    pub const TASKBAR_ITEM: Color   = Color::rgba(255, 255, 255, 10);
    pub const TASKBAR_HOVER: Color  = Color::rgba(255, 255, 255, 25);
    pub const TASKBAR_ACTIVE: Color = Color::rgba(255, 255, 255, 40);
    pub const TASKBAR_BORDER: Color = Color::rgba(255, 255, 255, 12);
    ...
    pub const WINDOW_BORDER_ACTIVE: Color = Color::rgba(0, 0, 0, 30);
    pub const WINDOW_BORDER_INACTIVE: Color = Color::rgba(0, 0, 0, 18);
    ...
    // Start menu
    pub const MENU_BG: Color     = Color::rgba(28, 28, 36, 240);
    pub const MENU_HOVER: Color  = Color::rgba(255, 255, 255, 18);
...
impl Text {
    ...
    pub const ON_DARK: Color   = Color::rgb(240, 240, 245);
...
pub struct Shadow;
impl Shadow {
    pub const LIGHT: Color  = Color::rgba(0, 0, 0, 15);
    pub const MEDIUM: Color = Color::rgba(0, 0, 0, 30);
    pub const HEAVY: Color  = Color::rgba(0, 0, 0, 55);
    pub const DROP: Color   = Color::rgba(0, 0, 0, 40);
}
...
impl IconColor {
    ...
    pub const SETTINGS: Color = Color::rgb(160, 160, 180);  // Gray
    pub const TRASH: Color    = Color::rgb(180, 180, 195);  // Cool gray
...
impl Radius {
    ...
    pub const BUTTON: u32 = 5;
    pub const INPUT: u32 = 5;
    pub const MENU: u32 = 8;
    pub const ICON: u32 = 10;
    pub const TASKBAR_ITEM: u32 = 5;
}
...
impl Size {
    ...
    pub const TASKBAR_HEIGHT: u32 = 44;
    pub const BUTTON_HEIGHT: u32 = 28;
    pub const INPUT_HEIGHT: u32 = 28;
    pub const ICON_SIZE: u32 = 36;
    pub const ICON_AREA: u32 = 72;
    pub const DESKTOP_ICON_GAP: u32 = 86;
    pub const MENU_ITEM_HEIGHT: u32 = 36;
    pub const MENU_WIDTH: u32 = 220;
    pub const SCROLL_BAR_W: u32 = 6;
    
    // Window control buttons
    pub const WIN_BTN_W: u32 = 36;
    pub const WIN_BTN_H: u32 = 32;
}
...
impl Shadows {
    pub const WINDOW: ShadowSpec = ShadowSpec {
        offset_x: 0, offset_y: 4, blur: 16, color: Color::rgba(0, 0, 0, 45),
    };
    pub const MENU: ShadowSpec = ShadowSpec {
        offset_x: 0, offset_y: 8, blur: 24, color: Color::rgba(0, 0, 0, 55),
    };
    pub const BUTTON: ShadowSpec = ShadowSpec {
        offset_x: 0, offset_y: 1, blur: 3, color: Color::rgba(0, 0, 0, 18),
    };
}
