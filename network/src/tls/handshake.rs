...
use super::{TlsVersion, CipherSuite, TlsError};
...
impl ClientHello {
    ...
    pub fn to_bytes(&self) -> Vec<u8> {
        ...
        // Cipher suites
        let cipher_bytes: Vec<u8> = self.cipher_suites
            .iter()
...
impl ServerHello {
    ...
    pub fn from_bytes(data: &[u8]) -> Result<Self, TlsError> {
        ...
        let cipher_suite = CipherSuite::from_id(cipher_id)
...
impl Extension {
    ...
    pub fn alpn(protocols: &[&str]) -> Self {
        ...
        Self::new(ExtensionType::ApplicationLayerProtocolNegotiation as u16, data)
    }
...
mod tests {
    ...
    fn test_supported_versions() {
        ...
        assert_eq!(u16::from_be_bytes([bytes[0], bytes[1]]), ExtensionType::SupportedVersions as u16);
    }
}
