    ...
    pub fn sections() -> Vec<SettingsSectionInfo> {
        alloc::vec![
            SettingsSectionInfo {
                ...
                description: String::from("디스플레이, 알림, 전원"),
                icon: String::from("monitor"),
            },
            SettingsSectionInfo {
                section: SettingsSection::Devices,
                name: String::from("장치"),
                description: String::from("블루투스, 프린터, 마우스"),
                icon: String::from("monitor"),
            },
            SettingsSectionInfo {
                section: SettingsSection::Network,
                name: String::from("네트워크"),
                description: String::from("Wi-Fi, VPN, 프록시"),
                icon: String::from("wifi"),
            },
            SettingsSectionInfo {
                section: SettingsSection::Personalization,
                name: String::from("개인 설정"),
                description: String::from("배경, 색상, 테마"),
                icon: String::from("palette"),
            },
            SettingsSectionInfo {
                section: SettingsSection::Apps,
                name: String::from("앱"),
                description: String::from("설치된 앱, 기본 앱"),
                icon: String::from("grid"),
            },
            SettingsSectionInfo {
                section: SettingsSection::Accounts,
                name: String::from("계정"),
                description: String::from("프로필, 로그인 옵션"),
                icon: String::from("user"),
            },
            SettingsSectionInfo {
                section: SettingsSection::Privacy,
                name: String::from("개인 정보"),
                description: String::from("위치, 카메라, 마이크"),
                icon: String::from("shield"),
            },
            SettingsSectionInfo {
                section: SettingsSection::Accessibility,
                name: String::from("접근성"),
                description: String::from("화면 읽기, 디스플레이, 오디오"),
                icon: String::from("accessibility"),
            },
            SettingsSectionInfo {
                section: SettingsSection::DateTime,
                name: String::from("날짜 및 시간"),
                description: String::from("시간대, 형식"),
                icon: String::from("clock"),
            },
            SettingsSectionInfo {
                section: SettingsSection::Language,
                name: String::from("언어 및 지역"),
                description: String::from("언어, 입력, 지역 형식"),
                icon: String::from("globe"),
            },
            SettingsSectionInfo {
                section: SettingsSection::Update,
                name: String::from("업데이트"),
                description: String::from("시스템 업데이트, 복구"),
                icon: String::from("refresh-cw"),
            },
            SettingsSectionInfo {
                section: SettingsSection::About,
                name: String::from("정보"),
                description: String::from("시스템 정보, 사양"),
