...
impl BookmarkManager {
    ...
    /// Create a bookmark.
    pub fn create_bookmark(&self, parent_id: BookmarkId, title: &str, url: &str) -> Option<BookmarkId> {
...
mod tests {
    ...
    fn test_bookmark_manager() {
        ...
        let bm_id = manager.create_bookmark(bar_id, "Google", "https://google.com").unwrap();
    ...
    fn test_folders() {
        ...
        manager.create_bookmark(folder_id, "Jira", "https://jira.example.com").unwrap();
    ...
    fn test_search() {
        ...
        let bar_id = manager.get_special_folder(SpecialFolder::BookmarksBar);
        manager.create_bookmark(bar_id, "Google", "https://google.com").unwrap();
        manager.create_bookmark(bar_id, "Rust Lang", "https://rust-lang.org").unwrap();
