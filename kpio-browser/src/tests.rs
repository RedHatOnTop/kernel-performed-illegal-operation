...
mod navigation_tests {
    ...
    fn test_url_host_extraction() {
        ...
        assert_eq!(get_host("https://example.com:8080/path"), Some("example.com"));
    }
...
mod csp_tests {
    ...
    fn test_csp_source_matching() {
        ...
        assert!(matches_source("https://cdn.example.com", "https://cdn.example.com/lib.js"));
...
mod extension_tests {
    ...
    fn test_content_script_matching() {
        ...
        assert!(matches_pattern("https://example.com/*", "https://example.com/page"));
        assert!(!matches_pattern("https://example.com/*", "https://other.com/page"));
    }
}
...
mod bridge_tests {
    ...
    use crate::kernel_bridge::{KernelBridge, AppState, BridgeError};
    use crate::fs_bridge::{FsBridge, FileType};
    use crate::network_bridge::{NetworkBridge, NetError};
