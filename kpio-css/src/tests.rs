...
mod selector_tests {
    ...
    fn test_specificity_comparison() {
        ...
        let a = Specificity { ids: 1, classes: 0, elements: 0 };
        let b = Specificity { ids: 0, classes: 10, elements: 0 };
...
#[cfg(test)]
mod value_tests {
    use crate::values::{CssValue, Length, Color};
...
#[cfg(test)]
mod cascade_tests {
    use crate::cascade::{Cascade, Origin, Importance};
    ...
    fn test_cascade_order() {
        ...
        fn cascade_compare(a: &CascadeEntry, b: &CascadeEntry) -> core::cmp::Ordering {
            ...
            if a.important != b.important {
                return if a.important { core::cmp::Ordering::Greater } else { core::cmp::Ordering::Less };
            }
        ...
        let a = CascadeEntry { origin: 1, important: false, specificity: (1, 0, 0), order: 0 };
        let b = CascadeEntry { origin: 1, important: true, specificity: (0, 0, 1), order: 1 };
    ...
    fn test_property_inheritance() {
        fn is_inherited(prop: &str) -> bool {
            matches!(prop, 
                ...
                "line-height" | "text-align" | "visibility" | "cursor" | "list-style-type"
            )
        }
...
mod stylesheet_tests {
    use crate::stylesheet::{StyleSheet, StyleRule};
